...
RUN apt-get update -y && apt-get install -y openssl ca-certificates netcat-openbsd
...
# Build-time variables for client-side envs
ARG NEXT_PUBLIC_MAPBOX_TOKEN
ARG GOOGLE_PLACES_API_KEY
ARG GOOGLE_CUSTOM_SEARCH_API_KEY
ARG GOOGLE_SEARCH_ENGINE_ID

ENV NEXT_PUBLIC_MAPBOX_TOKEN=$NEXT_PUBLIC_MAPBOX_TOKEN
ENV GOOGLE_PLACES_API_KEY=$GOOGLE_PLACES_API_KEY
ENV GOOGLE_CUSTOM_SEARCH_API_KEY=$GOOGLE_CUSTOM_SEARCH_API_KEY
