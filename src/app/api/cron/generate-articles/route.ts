    ...
    try {
        ...
        const savedArticle = await prisma.article.create({
            data: {
                ...
                whyItMatters: Array.isArray(article.whyItMatters) ? article.whyItMatters.join('\n\n') : article.whyItMatters,
                practicalTips: Array.isArray(article.practicalTips) ? article.practicalTips.join('\n\n') : article.practicalTips,
                technicalSection: Array.isArray(article.technicalSection) ? article.technicalSection.join('\n\n') : article.technicalSection,
                tags: article.tags,
